...
My personal configuration for CachyOS with Hyprland.
...
| `Super + Shift + S` | Take a region screenshot                            |
| `Print`             | Take a region screenshot and modify it with `satty` |
...
| `Super + M`         | Toggle power menu                                   |
| `Super + R`         | Toggle app launcher                                 |
| `Super + Z`         | Toggle music menu                                   |
