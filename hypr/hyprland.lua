...
hl.env("QS_ICON_THEME", "Colloid-Orange-Dark")
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"#fab387", "rgba(ff9e75ee)"}, angle = 45 },
...
hl.animation({ leaf = "border",        enabled = true,  speed = 5.9, bezier = "easeOutQuint" })
hl.animation({ leaf = "windows",       enabled = true,  speed = 4.79, spring = "easy" })
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 4.1,  bezier = "almostLinear",         style = "popin 87%" })
hl.animation({ leaf = "windowsOut",    enabled = true,  speed = 1.42, bezier = "easeInOutCubic",       style = "popin 87%" })
...
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 4.2, bezier = "easeInOutCubic", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 3.9, bezier = "easeInOutCubic", style = "slide" })
...
hl.bind(mainMod .. " + SHIFT + L", hl.dsp.window.move({ workspace = "special:magic" }))
